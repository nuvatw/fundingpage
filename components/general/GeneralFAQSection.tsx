...
import { GENERAL_FAQ_ITEMS, GENERAL_FAQ_CATEGORIES } from '@/lib/data';
...
export function GeneralFAQSection() {
  ...
  const filteredFAQs = useMemo(
    () => GENERAL_FAQ_ITEMS.filter((faq) => faq.category === activeCategory),
    [activeCategory]
  );
    ...
    <section id="faq" className="py-16 sm:py-24 bg-white">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-center mb-8">
          <SegmentedControl
            items={GENERAL_FAQ_CATEGORIES.map((cat) => ({
              id: cat.id,
              label: cat.label,
            }))}
